            ...
            <div class='row'>
                <div class='col-lg-4 col-md-4 col-sm-12 mt-2'>
                    <div class='row'>
                        ...
                        <div class='col-8'>
                            <form action='{{ url('/discounts-paginate') }}' method='get'>
                ...
                <div class='col-lg-4 col-md-4 col-sm-12 mt-2'>
                    <form action='{{ url('/discounts-filter') }}' method='get'>
                        <div class='input-group'>
                ...
                <div class='col-lg-4 col-md-4 col-sm-12 mt-2'>
                    <!-- Search Form -->
                    <form action='{{ url('/discounts-search') }}' method='GET'>
                        <div class='input-group'>
                ...
                <table class='table table-striped'>
                    <thead>
                        <tr>
                            ...
                            <th>#</th>
                            <th>Added By</th><th>Name</th><th>Discount</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        @forelse($discounts as $item)
                            <tr>
                                ...
                                <td>{{ $item->discount }}%</td>
                                <td>
                                    <a href='{{ route('discounts.restore', $item->id) }}'><i class='fas fa-recycle text-info'></i></a>
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.bulk-delete').click(function () {
                ...
                $.post('/discounts-delete-all-bulk-data', {
                    ids: array,
            ...
            $('.bulk-restore').click(function () {
                ...
                $.post('/discounts-restore-all-bulk-data', {
                    ids: array,
                    _token: $("meta[name='csrf-token']").attr('content')
                }, function (res) {
                    console.log(res)
